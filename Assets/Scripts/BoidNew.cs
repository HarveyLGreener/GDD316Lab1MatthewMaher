...
public class BoidNew : MonoBehaviour
{
    ...
    private NeighborhoodNew neighborhood;
    ...
    void Awake()
    {
        neighborhood = GetComponent<NeighborhoodNew>();
    ...
    private void FixedUpdate()
    {
        ...
        Vector3 delta = new Vector3(Attractor.POS.x, Attractor.POS.y+20f, Attractor.POS.z) - pos;
